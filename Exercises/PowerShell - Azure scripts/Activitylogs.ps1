...
{
$From = "vinay.bhimireddy@capgemini.com"
$To = "capgeminicloudservicespaassupport.in@capgemini.com"
$Cc = "halappscloudsupport.in@capgemini.com","baamsapps.in@capgemini.com"
$Attachment = $outpath
...
$tot = ($al).Count
if($tot -eq 0)
{ write-host " There are no resources deleted in the last 24 hours "
}
else
{
